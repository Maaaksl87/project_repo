...
export class Form {
    ...
    // Створює один блок форми з підписом (label) і полем вводу (input/select)
    ...
    //повертає елемент форми, щоб його можна було додати в DOM
    getFormElement() {
        return this.form;
    }
    ...
    onCreate(onFigureCreateCallback) {
        this.form.addEventListener("submit", (event) => {
            ...
            if (this.form[0].value !== "") {
                ...
                // якщо вдалося створити фігуру - очищаємо поля
                this.clear();
            } else {
