...
//! 028_9 *Поясніть, чому важливо уникати "callback hell" та як async / await допомагають у цьому.*

/*
Callback hell - це ситуація, коли ми вкладаємо багато функцій зворотного виклику одна в одну, що робить код важким для розуміння та підтримки.
async/await допомагає уникнути цього, оскільки дозволяє писати асинхронний код так, ніби він синхронний.



!028_10 **

async / await роблять асинхронний код більш лінійним і зрозумілим, полегшуючи читання, написання та обробку помилок у порівнянні з іншими двома способами. 
Вони дозволяють уникнути callback hell, спрощують структуру коду, забезпечують обробку помилок через try/catch. 
async / await чудово підходять для послідовного виконання асинхронних операцій, роблячи код більш зручним.
*/