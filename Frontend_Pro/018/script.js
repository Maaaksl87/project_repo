...
//ЗАВДАННЯ 7
/*
Завдяки ООП код стає більш читабельним і структурованим. Воно допомагає розділити різні компоненти на окремі блоки, що робить код зрозумілішим і простішим у підтримці. З огляду на ці переваги, ООП є доречним для розробки інтернет-магазину, оскільки дозволяє масштабувати код завдяки таким чотирьом механізмам, як інкапсуляція, абстракція, поліморфізм і наслідування.
*/
